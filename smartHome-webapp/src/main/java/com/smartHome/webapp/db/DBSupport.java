...
/** database tools for working with the sensors data to store in database */
public class DBSupport {
	...
	public void insertSensorsResponseEntity(SensorsResponseEntity entity) {
		...
		jdbcTemplate.update(sql, entity.getId(), entity.getDataResponse().getTemperature(), entity.getDataResponse().getPress(),
				entity.getDataResponse().getAlt(), entity.getDataResponse().getBattery(), localDateTime);
		log.info("DBSupport:: Sensor data inserted: " 
				+ "id: " + entity.getId() 
				...
				+ " Battery voltage: " + entity.getDataResponse().getBattery()
	...
	public void insertDataResponse(DataResponse data) {
		...
		jdbcTemplate.update(sql, id, data.getTemperature(), data.getPress(), data.getAlt(), data.getLight(), localDateTime);
		log.info("DBSupport:: sensor_data inserted: " + "id: " + id + " Temperature: " + data.getTemperature()
				+ " Humidity: " + data.getPress() + " Altitude: " + data.getAlt() + " Light: " + data.getLight() + " Battery voltage: "
				+ data.getBattery() + " Timestamp: " + localDateTime);
